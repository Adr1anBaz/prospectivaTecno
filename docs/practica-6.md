...
![Matriz de confusión](assets/practica-6/confusion_matrix.png)

### Latencia por ejecución

![Latencias](assets/practica-6/latencias.png)

### Tokens de salida vs latencia

![Tokens vs latencia](assets/practica-6/tokens_vs_latency.png)

### Tasas de éxito

![Tasas de éxito](assets/practica-6/success_rates.png)
